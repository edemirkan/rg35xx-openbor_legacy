...
#ifdef RG35XX
char* RG35XX_GetKeyName(int keycode)
{
		 if (keycode == RG35XX_BUTTON_UP)     return "Up";
	else if (keycode == RG35XX_BUTTON_DOWN)   return "Down";
	else if (keycode == RG35XX_BUTTON_LEFT)   return "Left";
	else if (keycode == RG35XX_BUTTON_RIGHT)  return "Right";
	else if (keycode == RG35XX_BUTTON_A)      return "A";
	else if (keycode == RG35XX_BUTTON_B)      return "B";
	else if (keycode == RG35XX_BUTTON_X)      return "X";
	else if (keycode == RG35XX_BUTTON_Y)      return "Y";
	else if (keycode == RG35XX_BUTTON_L1)      return "L1";
	else if (keycode == RG35XX_BUTTON_L2)      return "L2";
	else if (keycode == RG35XX_BUTTON_R1)      return "R1";
	else if (keycode == RG35XX_BUTTON_R2)      return "R2";
	else if (keycode == RG35XX_BUTTON_START)  return "Start";
	else if (keycode == RG35XX_BUTTON_SELECT) return "Select";
	else if (keycode == RG35XX_BUTTON_MENU) return "Menu";
	else return "...";
}
#endif
...
#elif RG35XX
	return RG35XX_GetKeyName(keycode);
