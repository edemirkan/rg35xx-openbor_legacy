...
#ifdef RG35XX
	#define	CONTROL_ESC                 RG35XX_BUTTON_SELECT
	#define	CONTROL_DEFAULT1_START		RG35XX_BUTTON_START
	#define	CONTROL_DEFAULT1_UP         RG35XX_BUTTON_UP
	#define	CONTROL_DEFAULT1_DOWN		RG35XX_BUTTON_DOWN
	#define	CONTROL_DEFAULT1_LEFT		RG35XX_BUTTON_LEFT
	#define	CONTROL_DEFAULT1_RIGHT		RG35XX_BUTTON_RIGHT
	#define	CONTROL_DEFAULT1_FIRE1		RG35XX_BUTTON_A
	#define	CONTROL_DEFAULT1_FIRE2		RG35XX_BUTTON_Y
	#define	CONTROL_DEFAULT1_FIRE3		RG35XX_BUTTON_R1
	#define	CONTROL_DEFAULT1_FIRE4		RG35XX_BUTTON_B
	#define	CONTROL_DEFAULT1_FIRE5		RG35XX_BUTTON_L1
	#define	CONTROL_DEFAULT1_FIRE6		RG35XX_BUTTON_X
	#define	CONTROL_DEFAULT1_SCREENSHOT	RG35XX_BUTTON_R2
